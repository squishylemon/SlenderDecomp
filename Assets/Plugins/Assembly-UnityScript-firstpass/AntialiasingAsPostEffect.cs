...
public class AntialiasingAsPostEffect : PostEffectsBase
{
	...
	{
		if ((bool)materialFXAAPreset2)
		{
			UnityEngine.Object.Destroy(materialFXAAPreset2);
		}
		if ((bool)materialFXAAPreset3)
		{
			UnityEngine.Object.Destroy(materialFXAAPreset3);
		}
		if ((bool)materialFXAAII)
		{
			UnityEngine.Object.Destroy(materialFXAAII);
		}
		if ((bool)materialFXAAIII)
		{
			UnityEngine.Object.Destroy(materialFXAAIII);
		}
		if ((bool)nfaa)
		{
			UnityEngine.Object.Destroy(nfaa);
		}
		if ((bool)ssaa)
		{
			UnityEngine.Object.Destroy(ssaa);
		}
		if ((bool)dlaa)
		{
			UnityEngine.Object.Destroy(dlaa);
		}
	}
