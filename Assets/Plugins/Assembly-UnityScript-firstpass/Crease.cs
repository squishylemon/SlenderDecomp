...
public class Crease : PostEffectsBase
{
	...
	public virtual void OnDisable()
	{
		...
		if ((bool)depthFetchMaterial)
		{
			UnityEngine.Object.DestroyImmediate(depthFetchMaterial);
		}
		if ((bool)creaseApplyMaterial)
		{
			UnityEngine.Object.DestroyImmediate(creaseApplyMaterial);
		}
	}
